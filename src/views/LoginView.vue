    ...
    <div class="intros-container">
        <div class="intro-control signin-intro">
            <div class="intro-control__inner">
                ...
                <button id="signup-btn">¿No tienes una cuenta aún? Regístrate.</button>
            </div>
        </div>
        <div class="intro-control signup-intro">
            <div class="intro-control__inner">
                <h2>¡Regístrate en CGM Rental!</h2>
                <p>
                ...
                <button id="signin-btn">¿Ya tienes una cuenta? Inicia sesión.</button>
            </div>
        </div>
    </div>
</div>
...
export default {
    ...
    methods: {
        login() {
            ...
            axios.post('http://https://fc39-201-234-124-122.ngrok-free.app/login', {}, {
                    headers: {
